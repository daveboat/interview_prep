...
class Solution(object):
    def asteroidCollision(self, asteroids):
        ...
        :rtype: List[int]
        """
        # this problem seems to imply using a stack approach. We add the elements of astroids one by one.
        # if the current astroid is positive and the next one is negative, we pop and append, or just pop
        # or not pop and not append, depending on the relative size, until either the negative astroid is
        # destroyed, the top of the stack is negative, or the stack is empty
